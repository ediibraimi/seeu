...
session_start();
$queary = "SELECT ifnull(SUM(price),0) total FROM memberships;";
...
/////
//////
$queryteachers = "SELECT count(*) numri FROM `teacher_profile`;";
$stmt1 = $conn->prepare($queryteachers);
$stmt1->execute();
$row1 = $stmt1->fetch();
$totalteacher = $row1['numri'];
/////
/////
$queryusers = "SELECT count(*) users FROM `teacher_profile`;";
$stmt2 = $conn->prepare($queryusers);
$stmt2->execute();
$row2 = $stmt2->fetch();
